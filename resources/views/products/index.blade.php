        ...
        <div class="table-responsive">
            <table class="table align-middle mb-0">
                ...
                <tbody id="productTableBody">
                    ...
                    <tr data-name="{{ strtolower($product->name) }}" data-category="{{ $product->category }}">
                        ...
                        <td class="text-center">
                            <span class="badge bg-{{ $product->category === 'Makanan' ? 'primary' : 'warning' }}">
                                {{ $product->category }}
                            </span>
                        </td>
                        <td class="text-center">Rp {{ number_format((int) $product->price, 0, ',', '.') }}</td>
                        <td class="text-center">
                            @if($product->has_stock)
                                    @php $st = (int) ($product->stock ?? 0); @endphp
                                    @if($st <= 0)
                        ...
                        <td class="text-center">
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-sm btn-outline-primary btn-edit"
                                        ...
                                        data-has_stock="{{ $product->has_stock }}"
