...
<head>
    ...
    <title>Qassirin - @yield('title')</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="brand">
            <img src="{{ asset('images/qassirin_logo.png') }}" alt="logo">
            <h4>Qassirin</h4>
        </div>
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link {{ request()->is('transaksi*') ? 'active' : '' }}"
               ...
               <span><i class="fa-solid fa-cash-register"></i> Transaksi</span>
                ...
                <a class="nav-link {{ request()->is('transaksi/open-bill') ? 'active' : '' }}"
                    href="{{ route('transaksi.openBill.page') }}">
            ...
            <div class="collapse submenu {{ request()->is('produk*') ? 'show' : '' }}" id="produkMenu">
            ...
            <a class="nav-link d-flex"
                ...
                aria-expanded="{{ request()->is('kas*') ? 'true' : 'false' }}">
                <span><i class="fa-solid fa-vault"></i> Rekap Kas</span>
                <i class="fa-solid fa-chevron-down small"></i>
            </a>
            <div class="collapse submenu {{ request()->is('kas*') ? 'show' : '' }}" id="kasMenu">
                <a class="nav-link" href="{{ route('kas.opening.form') }}">Buka Kasir</a>
                <a class="nav-link" href="{{ route('kas.closing.form') }}">Tutup Kasir</a>
                <a class="nav-link" href="{{ route('kas.history') }}">Riwayat Closing</a>
            </div>
            ...
            <a class="nav-link d-flex"
                ...
                aria-expanded="{{ request()->is('karyawan*') ? 'true' : 'false' }}">
                <span><i class="fa-solid fa-users"></i> Kelola Karyawan</span>
                <i class="fa-solid fa-chevron-down small"></i>
            </a>
            <div class="collapse submenu {{ request()->is('karyawan*') ? 'show' : '' }}" id="karyawanMenu">
    ...
    <div class="topbar">
        <div class="left">
            ...
            <img src="{{ asset('images/qassirin_logo.png') }}" style="height:30px;">
            <h5>Qassirin</h5>
        </div>
        ...
        <div class="right d-flex align-items-center gap-3">
            @auth
                <span class="user-role">
                    ...
                    {{ Auth::user()->name }} ({{ Auth::user()->role === 'owner' ? 'Owner' : 'Kasir' }})
                </span>
